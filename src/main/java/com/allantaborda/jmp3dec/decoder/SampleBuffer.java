...
/** The <code>SampleBuffer</code> class implements an output buffer that provides storage for a fixed size block of samples. */
public class SampleBuffer implements Obuffer{
