...
public class OutputChannels{
	...
	public static OutputChannels fromInt(int code){
		if(code == LEFT_CHANNEL) return LEFT;
		if(code == RIGHT_CHANNEL) return RIGHT;
		if(code == BOTH_CHANNELS) return BOTH;
		if(code == DOWNMIX_CHANNELS) return DOWNMIX;
	 ...
	 * @return The number of output channels for this channel output type. This will be 2 for BOTH_CHANNELS only, and 1 for all other types.
	 */
	...
	public boolean equals(Object o){
		if(o instanceof OutputChannels) return ((OutputChannels) o).outputChannels == outputChannels;
		return false;
	}
